...
class AuthControllerAdv extends Controller
{
    ...
    public function register(Request $request) {
        Log::info('Registration attempt received from IP: ', $request->all());
    ...
    public function login(Request $request) {
        try{
            Log::info('Login attempt received from IP: ', $request->all());
    ...
    {
        Log::info('User logged out from IP: ', $request->all());
        Auth::logout();
